...
class Cosmos3ReasonerForConditionalGeneration(Cosmos3ReasonerPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = Cosmos3ReasonerForConditionalGeneration.from_pretrained("Qwen/Qwen3-VL-8B-Instruct")
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        # Overwritten -- Cosmos3Reasoner use timestamps and remove second_per_grid_ts
        ...
        def _expand_dict_for_generation_visual(dict_to_expand):
            ...
            # but Cosmos3Reasoner append vision_start to each frame of each video, so we need to recover the real video_nums according to video_grid_thw
            if video_grid_thw is not None:
